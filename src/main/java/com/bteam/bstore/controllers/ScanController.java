...
public class ScanController {
	...
	public static final String REQUEST_URI = "https://ee75ln89fb.execute-api.ap-southeast-1.amazonaws.com/test/imagerekog";
	...
	public ArrayList<ScannedItem> scannedItems() {
		  ...
		  ResponseEntity<Map> response =  restTemplate.postForEntity(REQUEST_URI, entity, Map.class); 
		  ArrayList<ScannedItem> items = (ArrayList<ScannedItem>) response.getBody().get("Labels");
		/*  ArrayList<ScannedItem> scannedItems = null;
		  long id=0;
		  for(int i=0;i<items.size();i++){
			  ScannedItem tempItem = new ScannedItem(id++, items.get(i).getName());
			 scannedItems.add(tempItem);
		  }
		  return scannedItems;
		  */
		  return items;
